...
$getGroup = Get-AzResourceGroup -Name "QSI-QA-INFRA-RG"
$getVm = Get-AzVM -Name "WIN-01"
$securePassword = ConvertTo-SecureString 'P4$$w0rd' -AsPlainText -Force
$cred = New-Object System.Management.Automation.PSCredential ("qsi", $securePassword)
########################################
